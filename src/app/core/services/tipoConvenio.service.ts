...
import { ITipoConvenio } from '../interface/tipoconvenio';
import { TipoConvenio } from '../models/tipoConvenio.model';
...
export class TipoConvenioService {
  ...
  public getTipoConvenios():Observable<ITipoConvenio[]>{
    return this.httpClient.get<ITipoConvenio[]>(`${this.URL}TIPOCONVENIO/listTipoConvenio`);
  }
